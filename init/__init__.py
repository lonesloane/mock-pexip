...
PEXIP_SERVICE_HOST = os.environ.get("PEXIP_SERVICE_HOST", "localhost")
PEXIP_SERVICE_PORT = os.environ.get("PEXIP_SERVICE_PORT", "8085")

LOGGING_LEVEL = os.environ.get('LOGGING_LEVEL', 'DEBUG')
LOG_FILE = os.environ.get('LOG_FILE', "./logs/mock-pexip.log")
